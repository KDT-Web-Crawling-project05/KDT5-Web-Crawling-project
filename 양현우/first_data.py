...
if __name__ == '__main__':
    search_word = "생명공학 빅데이터"    # 검색어 지정
    title_list = []
    stopwords = [search_word, '데이터', 'ChatGPT', '기업', '평판', '바이오', '생명공학', '빅데이터', '분석', '활용', '개발']    # wordcloud에서 제외할 단어

    # 1~200번 게시글까지 크롤링
    get_titles(1, 200, search_word, title_list) # 200개의 뉴스 검색
